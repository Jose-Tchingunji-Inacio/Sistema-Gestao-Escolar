<?php include("banco/publicar.php"); ?>
<html>
<head>
    ...
    <div class="nav-wrapper container ">
      <a href="#" class="brand-logo right"><i class="">Instituto 30 Setembro</i></a>
        ...
        <ul id="nav-mobile" class="left hide-on-med-and-down">
           <li><a href="#"><i class="fa fa-cloud-upload right"></i>Postar Noticia</a></li>
            <li><a href="postar_fotografia.php"><i class="fa fa-cloud-upload right"></i>Postar Fotografia</a></li>
       ...
       <div class="row">
        ...
        <div class="col l7 s12">
            <!--Fazer upload de noticia-->
            <p class="left">Upload de noticias</p>
            
            <div class="col l12 s12" >
                <form method="post" action="indexAdmin.php" enctype="multipart/form-data">
                <div class="input-field col s6">
                 <i class="fa fa-newspaper-o prefix"></i><input type="text" name="titulo_noticia" id="noticia" >
                    <label for="noticia">Titulo da noticia</label>
                </div>
                ...
                <div class="input-field col s12">
                    ...
                    <textarea id="text" class="materialize-textarea" name="noticia"></textarea>
                     <label for="text">A Noticia</label>
                 </div>
                <div class="row">
                        <div class="col s5">
