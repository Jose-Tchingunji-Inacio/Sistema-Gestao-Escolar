<?php include("banco/publicar_video.php"); ?>
<html>
<head>
      ...
      <a href="#" class="brand-logo right"><i class="">Instituto 30 Setembro</i></a>
        ...
        <ul id="nav-mobile" class="left hide-on-med-and-down">
           <li><a href="indexAdmin.php"><i class="fa fa-cloud-upload right"></i>Postar Noticia</a></li>
            ...
            <li><a href="#"><i class="fa fa-cloud-upload right"></i>Postar Video</a></li>
            <li><a href="../galeria.php"><i class="fa fa-edit"> Alterar</i></a></li>
            <li><a href="../fala_conosco.php" ><i class="fa fa-eject"> Eliminar</i></a></li>
       ...
       <div class="row">
        ...
        <div class="col l7 s12">
            ...
            <div class="col l12 s12">
                <p class="left">Upload de videos</p>
                <form method="post" action="postar_video.php" enctype="multipart/form-data">
